...
func MyLimit() gin.HandlerFunc {
	...
	lmt := tollbooth.NewLimiter(float64(_config.Server.LimitCountPerRequest), nil)
	return func(c *gin.Context) {
...
func Security() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		//c.Writer.Header().Add("Content-Security-Policy", "default-src 'self';") ## disabled as stop swagger from working
